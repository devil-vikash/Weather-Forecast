...
const apiUrl = `https://api.sunrise-sunset.org/json?lat=36.7201600&lng=-4.4203400&callback=mycallback`;
const sunriseTime = "05:45 AM";
const sunsetTime = "06:35 PM";
...
sunriseTimeBtn.addEventListener('click', function () {
    wheatherFiled.classList.add('d-none');
    cityFiled.classList.add('d-none');
    mapFiled.classList.remove('d-none');
})
